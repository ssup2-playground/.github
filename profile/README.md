...
|Name|Description|
|---|---|
|[bedrock-multi-region-pnetwork](https://github.com/ssup2-playground/bedrock-multi-region-pnetwork_project)|Prototyping project that uses multi-region bedrock using a private.|
